...
import 'package:safeguard_home_ai/screens/loginpage.dart';
                  ...
                  child: Expanded(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          FadeAnimation(1, Center(child: Text("Welcome",
                            style: TextStyle(color: Colors.white, fontSize: 50),))),
                          SizedBox(height: 15,),
                          FadeAnimation(1.3, Center(child: Text("We promise that you'll have the most \nfuss-free time with us ever.",
